...
// Div). Other helper functions are provided too.
//
...
// from the Val method.
//
// 2. Any element with a named type that doesn't satisfies the Operander
// interface will obtain its value from its underlying type.
//
...
//
// 5. Composed (arrays, maps, slices, strings, structs) and channel elements
// will be represented by their length (or their number of fields for structs).
//
